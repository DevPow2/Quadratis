...
Adafruit_ILI9341 tft = Adafruit_ILI9341(27, 5, 13, 14, 33);
Adafruit_ILI9341 tft2 = Adafruit_ILI9341(22, 32, 13, 14, 25);
...
void loop()
{
  ...
  for (long i = 0; i < (360 * n); i++) {
    ...
    yy1 = sy * r + yy0 * 2;
    //Serial.println(yy1);
    if(yy1 > 240) tft2.drawPixel(x1, yy1 - 240, rainbow(map(i % 360, 0, 360, 0, 127))); //colour);
    else tft.drawPixel(x1, yy1, rainbow(map(i % 360, 0, 360, 0, 127))); //colour);
  }
